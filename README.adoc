...
== P2P and Non-Symmetric NAT

The P2P peers will send a request from port 6881 to any Public STUN (RFC5389) server requesting for their public IP addresses and port numbers.
